  ...
  <div class="space-y-4">
    <div class="flex justify-between items-center">
      <h2 class="text-lg font-bold flex items-center">
        ...
        Active Drones ({{ store.activeDrones.length }})
      </h2>
      <button
        @click="refreshData"
    ...
    <div v-else-if="store.activeDrones.length === 0" class="text-center text-gray-500 py-4">
      ...
      >
        <div class="flex justify-between items-start">
          ...
          <div class="text-right">
            <div class="text-xs text-gray-500">{{ timeAgo(drone.last_seen) }}</div>
...
import { timeAgo, isRecent, shortenMac } from '@/utils/helpers'
